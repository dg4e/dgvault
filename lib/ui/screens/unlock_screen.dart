            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TerminalPanel(
                    title: 'authenticate',
                    accent: c.error != null ? TermColors.red : TermColors.border,
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        const _BootLog(),
                  ...
                  const SizedBox(height: 14),
                  Text('hint: demo pin is ${VaultController.demoPin}',
          ...
          Padding(
            ...
            child: RichText(
              text: TextSpan(children: [
                TextSpan(text: '  ➜ ', style: mono(size: 12, color: TermColors.greenDim)),
                TextSpan(text: '$k: ', style: mono(size: 12, color: TermColors.textDim)),
                TextSpan(text: v, style: mono(size: 12, color: TermColors.text)),
              ],),
            ),
          ),
      ],
